...
public abstract class MongoRepository<TEntity> : MongoRepository<TEntity, int> where TEntity : class, IMongoEntity<int>, IMongoRepository<TEntity>, IAggregateRoot
{
}