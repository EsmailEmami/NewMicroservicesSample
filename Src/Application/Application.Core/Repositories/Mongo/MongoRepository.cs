...
public abstract class MongoRepository<TEntity, TPrimaryKey> : IMongoRepository<TEntity, TPrimaryKey>
...
public abstract class MongoRepository<TEntity> : MongoRepository<TEntity, int> where TEntity : class, IEntity<int>
{
}